...
import (
	...
	restcontrollers "github.com/mahendraintelops/dsddsds/dddds/pkg/rest/server/controllers"
...
func main() {
	...
	dadadController, err := restcontrollers.NewDadadController()
	if err != nil {
	...
	v1 := router.Group("/v1")
	{
		...
		v1.POST("/dadads", dadadController.CreateDadad)

		v1.GET("/dadads/:id", dadadController.FetchDadad)
